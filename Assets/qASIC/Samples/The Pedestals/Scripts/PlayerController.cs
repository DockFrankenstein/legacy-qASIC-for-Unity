...
using qASIC.Samples.Pedestal.Dialogue;
using qASIC.Samples.Pedestal.ColorZones;

namespace qASIC.Samples.Pedestal
{
#if !qASIC_DEV
	[AddComponentMenu("")]
#endif
    public class PlayerController : MonoBehaviour
	{
        ...
        private void Update()
        {
            ...
            rb.velocity = new Vector2(InputManager.GetFloatInput("Horizontal"), InputManager.GetFloatInput("Vertical")) * speed * SpeedMultiplier;
